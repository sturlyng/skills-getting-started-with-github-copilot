...
activities = {
    ...
    "Basketball Team": {
        "description": "Team basketball training and intramural games",
    ...
    "Drama Club": {
        "description": "Acting exercises, rehearsal, and performance preparation",
        "schedule": "Tuesdays and Fridays, 4:00 PM - 5:30 PM",
        "max_participants": 20,
        "participants": ["emma@mergington.edu", "luca@mergington.edu"]
    },
    "Debate Team": {
